...
RUN wget https://github.com/tomfitzhenry/ct-watch-http-scala/releases/download/0.8/ct-watch-http-scala-assembly-0.8.jar

CMD java -jar ct-watch-http-scala-assembly-0.8.jar
