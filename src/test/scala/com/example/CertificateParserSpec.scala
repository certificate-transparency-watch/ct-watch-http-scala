...
class CertificateParserSpec extends Specification with Specs2RouteTest {
  ...
  "CertificateParser" should {
    "parse a github.com cert" in {
      ...
      val cert = certificateParser.parse(githubCert)
      cert.serialNumber === BigInt("15953718796281471505685363726901697671")
      cert.expiry === new DateTime(2016,4,12,13,0,0)
      cert.commonName === "github.com"
      cert.subjectAlternativeNames === List("github.com", "www.github.com")
    }
  }
